...
{get ;}
/// <summary>
/// Mou una persona de (filOrig, colOrig) fins a la posicio adjacent (filDesti,c
olDesti)
/// Es suposa que les coordenades són vàlides, que hi ha una persona a l'origen
i que
/// el destí està buit.
/// </summary>
...
private void Moure (int filOrig, int colOrig, int filDesti, int colDesti)/// <summary>
